...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Your feelings. Safe. Anonymous. Heard.'**
  String get tagline;
  ...
  /// No description provided for @needToTalk.
  ///
  /// In en, this message translates to:
  /// **'Need to talk?'**
  String get needToTalk;
  ...
  /// No description provided for @findSupport.
  ///
  /// In en, this message translates to:
  /// **'Find Support'**
  String get findSupport;
  ...
  /// No description provided for @communityCircles.
  ///
  /// In en, this message translates to:
  /// **'Community Circles'**
  String get communityCircles;
